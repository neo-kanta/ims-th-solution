-- =============================================================================
-- Investment process assignment demo seed (development/test only)
-- =============================================================================
-- Extracted from the former database/seeds/004_investment_process_assignment_seed.sql.
-- Creates the named demo users (ben, green, neo) and assigns them to demo
-- process groups so process-step execution can be exercised end to end in
-- development. This file is only executed when APP_ENV is development or
-- test (see backend/cmd/seed/sql_seeds.go); it must never reach production.
--
-- Reference process-step definitions (ANALYSIS_REPORT, INVESTMENT_DECISION,
-- INVESTMENT_EXECUTION, INVESTMENT_REVIEW) remain in the always-run
-- database/seeds/004_investment_process_assignment_seed.sql and are a
-- prerequisite for this file.
--
-- Seeds:
--   Group A: Ben + Green
--   Group B: Neo
