      ...
      <div class="settings-user-detail__body">
        ...
        >
          ...
          >
            ...
            <div class="settings-password-field">
              <input
                ...
                v-model="newPassword"
                class="input"
                data-testid="iam-user-reset-password-input"
          ...
          <AppButton
            ...
            variant="primary"
            size="sm"
            data-testid="iam-user-reset-password-submit"
