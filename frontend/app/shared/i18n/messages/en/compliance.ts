export const enComplianceMessages = {
  compliance: {
    // Shared pager (used by post-trade breaches and rule library pages)
    pager: {
      navLabel: "Pagination",
      perPage: "Per page",
      of: "of",
    ...
    postTrade: {
      title: "Breaches",
      description:
        "Post-trade compliance breach queue — recorded after trade capture or during periodic replay.",
      limitationNotice:
        "Overriding an open breach is supported; general breach status transitions are not yet available.",
      refresh: "Refresh",
      refreshing: "Refreshing…",
      lastRefreshed: "Last refreshed {time}",
      lastRefreshedNever: "Not yet refreshed",
      ...
      toolbar: {
        ...
        portfolioPlaceholder: "Search portfolio code or name",
        portfolioAny: "All portfolios",
        portfolioChange: "Change",
        portfolioLoading: "Loading portfolios…",
        portfolioEmpty: "No portfolios match.",
        portfolioUnavailable:
          "Portfolio names could not be loaded, so portfolio filtering is disabled.",
        ruleLabel: "Rule",
        ruleAny: "All rules",
        dateRangeLabel: "Business date",
        activeFilters: "Filters",
        clearAll: "Clear all",
        removeFilter: "Remove filter",
        chipRule: "Rule: {label}",
        chipPortfolio: "Portfolio: {label}",
        chipDateFrom: "From {date}",
        chipDateTo: "Until {date}",
      ...
      table: {
        ...
        override: "Override…",
        overridePermissionRequired: "IRG_OVERRIDE_BREACH permission required.",
        overrideNotOpen: "Only OPEN breaches can be overridden.",
        noAction: "No action available",
        recordedAt: "Recorded {time}",
      },
      states: {
        loading: "Loading breaches…",
        errorTitle: "Could not load breaches",
        retry: "Retry",
        emptyNoBreachesTitle: "No breaches recorded",
        emptyNoBreachesDescription:
          "No compliance breaches have been recorded for this queue yet.",
        emptyFilteredTitle: "No breaches match these filters",
        emptyFilteredDescription:
          "Try widening the business date range or clearing a filter.",
        clearFilters: "Clear filters",
        portfolioDirectoryError:
          "Portfolio names could not be loaded ({error}). Rows show a limited portfolio detail until this is retried.",
        portfolioDirectoryRetry: "Retry portfolio names",
      },
      drawer: {
        title: "Breach details",
        ariaLabel: "Compliance breach details",
        close: "Close",
        sectionSummary: "Summary",
        sectionRisk: "Risk",
        sectionDates: "Dates",
        sectionEvidence: "Evidence",
        sectionRecords: "Check records ({count})",
        rule: "Rule",
        ruleTypeId: "Rule type ID",
        portfolio: "Portfolio",
        message: "Message",
        messageEmpty: "No message was recorded.",
        severity: "Severity",
        verdict: "Verdict",
        status: "Status",
        businessDate: "Business date",
        createdAt: "Recorded",
        resolvedAt: "Resolved",
        resolvedByHidden: "Recorded — reviewer identity is not shown here.",
        noEvidence: "No structured evidence was recorded for this breach.",
        evidenceMetrics: "Metrics",
        evidenceReferences: "References",
        evidenceThreshold: "Threshold",
        thresholdActual: "Actual",
        thresholdLimit: "Limit",
        thresholdOperator: "Operator",
        thresholdMetric: "Metric",
        noRecords: "No check records were returned for this group.",
        recordVerdict: "Verdict",
        recordSeverity: "Severity",
        loading: "Loading check group…",
        errorTitle: "Could not load the check group",
        retry: "Retry",
        openAuditTrail: "Open in audit trail",
        override: "Override…",
      },
      override: {
        ...
        reasonRequired: "Enter a reason for this override.",
        reasonHelp: "Recorded on the immutable audit trail.",
        cancel: "Cancel",
        ...
        conflict:
          "This breach was already handled by someone else. Refresh the list and try again.",
      },
      groupDrawer: {
        title: "Check group",
